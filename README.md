...
elseif game.PlaceId == 7449423635 then
    ...
    game:GetService("Players").Play hub:Kick("Do not Support, Please wait...")
end

function CheckQuest() 
    MyLevel = game:GetService("Players").LocalPlayer.Data.Level.Value
    if World1 then
        if MyLevel == 2  or MyLevel <= 10 then
            Mon = "Bandit"
            LevelQuest = 1
